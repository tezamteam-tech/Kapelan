...
const DEFAULT_WAREHOUSE: WarehouseItem[] = [
  ...
  // ── Кондиционери (обладнання в наявності) ─────────────────────────────────
  { id: 'wh_ac_ch07',    name: 'Cooper&Hunter CH-S07FTXF2-NG Wi-Fi (7000 BTU)', category: 'Кондиционери', unit: 'шт', stock: 3, minStock: 1, price: 15900, sku: 'AC-CH-07K', supplier: 'Cooper&Hunter UA', itemType: 'equipment', imageUrl: 'https://images.unsplash.com/photo-1759772238012-9d5ad59ae637?w=600', acSpecs: { btu: 7000, kw: 2.1, areaMin: 15, areaMax: 22, tier: 'economy', equipmentId: 'eq_split_eco_07', refrigerant: 'R32', warranty: 3, features: ['Інвертор', 'Wi-Fi', 'Обігрів -15°C'], equipmentType: 'split_ac' }, updatedAt: now(), createdAt: now() },
  { id: 'wh_ac_midea09', name: 'Midea MSAFAU-09HRDN1 (9000 BTU)',               category: 'Кондиционери', unit: 'шт', stock: 2, minStock: 1, price: 18500, sku: 'AC-MID-09K', supplier: 'Midea UA',          itemType: 'equipment', imageUrl: 'https://images.unsplash.com/photo-1759772238012-9d5ad59ae637?w=600', acSpecs: { btu: 9000, kw: 2.6, areaMin: 22, areaMax: 30, tier: 'economy', equipmentId: 'eq_split_eco_09', refrigerant: 'R32', warranty: 3, features: ['Інвертор', 'Авторестарт', 'Обігрів -15°C'], equipmentType: 'split_ac' }, updatedAt: now(), createdAt: now() },
  { id: 'wh_ac_midea12', name: 'Midea MSAFAU-12HRDN1 (12000 BTU)',              category: 'Кондиционери', unit: 'шт', stock: 2, minStock: 1, price: 22000, sku: 'AC-MID-12K', supplier: 'Midea UA',          itemType: 'equipment', imageUrl: 'https://images.unsplash.com/photo-1759772238012-9d5ad59ae637?w=600', acSpecs: { btu: 12000, kw: 3.5, areaMin: 30, areaMax: 40, tier: 'economy', equipmentId: 'eq_split_eco_12', refrigerant: 'R32', warranty: 3, features: ['Інвертор', 'Авторестарт', 'Обігрів -15°C'], equipmentType: 'split_ac' }, updatedAt: now(), createdAt: now() },
  { id: 'wh_ac_sam09',   name: 'Samsung AR09TXHQASINUA WindFree (9000 BTU)',    category: 'Кондиционери', unit: 'шт', stock: 1, minStock: 1, price: 27000, sku: 'AC-SAM-09K', supplier: 'Samsung UA',        itemType: 'equipment', imageUrl: 'https://images.unsplash.com/photo-1759772238012-9d5ad59ae637?w=600', acSpecs: { btu: 9000, kw: 2.6, areaMin: 22, areaMax: 30, tier: 'standard', equipmentId: 'eq_split_std_09', refrigerant: 'R32', warranty: 5, features: ['Інвертор', 'Wi-Fi', 'Тихий режим', 'Обігрів -20°C'], equipmentType: 'split_ac' }, updatedAt: now(), createdAt: now() },
  { id: 'wh_ac_sam12',   name: 'Samsung AR12TXHQASINUA WindFree (12000 BTU)',   category: 'Кондиционери', unit: 'шт', stock: 2, minStock: 1, price: 31000, sku: 'AC-SAM-12K', supplier: 'Samsung UA',        itemType: 'equipment', imageUrl: 'https://images.unsplash.com/photo-1759772238012-9d5ad59ae637?w=600', acSpecs: { btu: 12000, kw: 3.5, areaMin: 30, areaMax: 42, tier: 'standard', equipmentId: 'eq_split_std_12', refrigerant: 'R32', warranty: 5, features: ['Інвертор', 'Wi-Fi', 'Тихий режим', 'Обігрів -20°C'], equipmentType: 'split_ac' }, updatedAt: now(), createdAt: now() },
  { id: 'wh_ac_lg18',    name: 'LG S18ET.NSKSUA Dual Inverter (18000 BTU)',     category: 'Кондиционери', unit: 'шт', stock: 1, minStock: 1, price: 43000, sku: 'AC-LG-18K',  supplier: 'LG Ukraine',        itemType: 'equipment', imageUrl: 'https://images.unsplash.com/photo-1759772238012-9d5ad59ae637?w=600', acSpecs: { btu: 18000, kw: 5.0, areaMin: 42, areaMax: 58, tier: 'standard', equipmentId: 'eq_split_std_18', refrigerant: 'R32', warranty: 5, features: ['Інвертор', 'Wi-Fi', 'Очищення повітря', 'Обігрів -20°C'], equipmentType: 'split_ac' }, updatedAt: now(), createdAt: now() },
  { id: 'wh_ac_lg24',    name: 'LG S24ET.NSKSUA Dual Inverter (24000 BTU)',     category: 'Кондиционери', unit: 'шт', stock: 1, minStock: 1, price: 57000, sku: 'AC-LG-24K',  supplier: 'LG Ukraine',        itemType: 'equipment', imageUrl: 'https://images.unsplash.com/photo-1759772238012-9d5ad59ae637?w=600', acSpecs: { btu: 24000, kw: 7.0, areaMin: 58, areaMax: 78, tier: 'standard', equipmentId: 'eq_split_std_24', refrigerant: 'R32', warranty: 5, features: ['Інвертор', 'Wi-Fi', 'Очищення повітря', 'Обігрів -20°C'], equipmentType: 'split_ac' }, updatedAt: now(), createdAt: now() },
  { id: 'wh_ac_daikin09',name: 'Daikin FTXB25C/RXB25C Eco (9000 BTU)',          category: 'Кондиционери', unit: 'шт', stock: 1, minStock: 1, price: 46000, sku: 'AC-DAI-09K', supplier: 'Daikin Ukraine',     itemType: 'equipment', imageUrl: 'https://images.unsplash.com/photo-1759772238012-9d5ad59ae637?w=600', acSpecs: { btu: 9000, kw: 2.5, areaMin: 22, areaMax: 30, tier: 'premium', equipmentId: 'eq_split_prm_09', refrigerant: 'R32', warranty: 7, features: ['Інвертор', 'Wi-Fi', 'Тихий режим', 'Обігрів -25°C'], equipmentType: 'split_ac' }, updatedAt: now(), createdAt: now() },
  { id: 'wh_ac_daikin12',name: 'Daikin FTXB35C/RXB35C Eco (12000 BTU)',         category: 'Кондиционери', unit: 'шт', stock: 2, minStock: 1, price: 54000, sku: 'AC-DAI-12K', supplier: 'Daikin Ukraine',     itemType: 'equipment', imageUrl: 'https://images.unsplash.com/photo-1759772238012-9d5ad59ae637?w=600', acSpecs: { btu: 12000, kw: 3.4, areaMin: 30, areaMax: 42, tier: 'premium', equipmentId: 'eq_split_prm_12', refrigerant: 'R32', warranty: 7, features: ['Інвертор', 'Wi-Fi', 'Тихий режим', 'Обігрів -25°C'], equipmentType: 'split_ac' }, updatedAt: now(), createdAt: now() },
  { id: 'wh_ac_mels18',  name: 'Mitsubishi Electric MSZ-LN50VG (18000 BTU)',    category: 'Кондиционери', unit: 'шт', stock: 1, minStock: 1, price: 82000, sku: 'AC-ME-18K',  supplier: 'Mitsubishi Electric', itemType: 'equipment', imageUrl: 'https://images.unsplash.com/photo-1759772238012-9d5ad59ae637?w=600', acSpecs: { btu: 18000, kw: 5.0, areaMin: 42, areaMax: 58, tier: 'premium', equipmentId: 'eq_split_prm_18', refrigerant: 'R32', warranty: 7, features: ['Інвертор', 'Wi-Fi', 'Дизайнерський', 'Обігрів -25°C'], equipmentType: 'split_ac' }, updatedAt: now(), createdAt: now() },
  // ── Фанкойли (в наявності) ────────────────────────────────────────────────
  { id: 'wh_fc_dai_cass12', name: 'Daikin FFQ35B Кассетний фанкойл (12000 BTU)', category: 'Кондиционери', unit: 'шт', stock: 2, minStock: 1, price: 28000, sku: 'FC-DAI-C12', supplier: 'Daikin Ukraine', itemType: 'equipment', imageUrl: 'https://images.unsplash.com/photo-1647202179310-bab5817b7c89?w=600', acSpecs: { btu: 12000, kw: 3.5, areaMin: 25, areaMax: 50, tier: 'premium', equipmentId: 'eq_fancoil_cassette_12', refrigerant: 'water', warranty: 5, features: ['Вода (від чилера)', 'Касетний монтаж', 'Дренажний насос'], equipmentType: 'fan_coil' }, updatedAt: now(), createdAt: now() },
  { id: 'wh_fc_rc_floor09', name: 'Royal Clima RCFC-FKR-09 Підлоговий фанкойл', category: 'Кондиционери', unit: 'шт', stock: 3, minStock: 1, price: 18000, sku: 'FC-RC-F09',  supplier: 'Royal Clima UA',  itemType: 'equipment', imageUrl: 'https://images.unsplash.com/photo-1647202179310-bab5817b7c89?w=600', acSpecs: { btu: 9000, kw: 2.6, areaMin: 18, areaMax: 35, tier: 'standard', equipmentId: 'eq_fancoil_floor_09', refrigerant: 'water', warranty: 3, features: ['Вода (від чилера)', 'Підлоговий', 'Гравітаційний дренаж'], equipmentType: 'fan_coil' }, updatedAt: now(), createdAt: now() },
];
