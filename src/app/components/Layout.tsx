...
const NAV_ITEMS: NavItem[] = [
  ...
  { path: "/tasks", label: "Монтажи", icon: <Wrench size={20} />, roles: ["admin", "manager", "installer"] },
  { path: "/calendar", label: "Календарь", icon: <CalendarDays size={20} />, roles: ["admin", "manager", "installer"] },
  { path: "/warehouse", label: "Склад", icon: <Package size={20} />, roles: ["admin", "manager", "installer"] },
